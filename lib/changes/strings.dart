String hellotag = '''Hi there, Welcome to My Company  ''';

String yourname = "I'm Hatay Berkay Işıkoğlu.";
...
String contactSubHeadding =
    "Let’s work together and make everything super cute and super useful for your company.";
//
String miniDescription =
    "Co-Founder providing services for programming and design content needs. Join me down below and let's get started!";
...
const String aboutMeHeadline =
    'I\'m  Hatay Berkay Işıkoğlu, a Mobile App developer, Web developer and UI designer.';

/*const String aboutMeDetail =
    'I\'m a Fresh Graduate as Software Engineer from Quanrt University, TR. I have been developing mobile apps for over 4 years now. '
    ...
    '. Been a CEO/Co-Founder of Onyxsio, Sri Lanka. Currently working as an Associate Software Engineer at Onyxsio.';*/
