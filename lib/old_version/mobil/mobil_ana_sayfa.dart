...
import '../../useless_things/Constants.dart';
class mobil_ana_sayfa extends StatefulWidget {
  const mobil_ana_sayfa({Key? key}) : super(key: key);

  @override
  _mobil_ana_sayfaState createState() => _mobil_ana_sayfaState();
}

class _mobil_ana_sayfaState extends State<mobil_ana_sayfa> {
                ...
                child: Column(
                  ...
                  [
                    ...
                    FittedBox(
                      ...
                      child: Text("MERHABA, BENİM ADIM" , style: TextStyle( fontSize: 30.0,
                    ...
                    FittedBox(
                      ...
                      fit: BoxFit.scaleDown,
                      child: Text("Ben bir Web sitesi ve Mobil uygulama geliştiricisiyim." ,style: TextStyle(
                        fontSize: 30.0,
                        fontWeight: FontWeight.bold,
                        fontFamily: 'Avenir',
          ...
          Container(
            ...
            child: Column(
                ...
                children: [
                  ...
                  Container(
                      width: 300,
                      child: Text("Sosyal medya Hesaplarımı takip edebilirsiniz." , style: TextStyle(fontSize: 20, color: Colors.white))),
          ...
          Container(
            ...
            child: Column(
                ...
                children: [
                  ...
                  Container(
                      width: 300,
                      child: Text("Copyright © 2020. Bir Hatay Berkay Projesidir." , style: TextStyle(fontSize: 20, color: Colors.white),)),
                  SizedBox(height: 25,),
