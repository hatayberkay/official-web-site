...
class tablet_ana_sayfa extends StatefulWidget {
  const tablet_ana_sayfa({Key? key}) : super(key: key);

  @override
  _tablet_ana_sayfaState createState() => _tablet_ana_sayfaState();
}

class _tablet_ana_sayfaState extends State<tablet_ana_sayfa> {
